function googlepedia_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
googlepedia_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				googlepedia_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
googlepedia_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
googlepedia_xmlhttpRequester.prototype.setupRequestEvent =
